...
type WorkflowProps = { title?: string; highlight?: string; introText?: string; isoText?: string; images?: string[] };

const Workflow = ({ title, highlight, introText, isoText, images }: WorkflowProps) => {
  const defaultImages = [
