...
export const metadata: Metadata = {
  ...
  description:
    'Connect packaging workflows, asset systems and approval tools seamlessly using 5Flow workflow integration solutions.',
};
    ...
    <div className="relative">
      <div className="container mx-auto mb-32">
        ...
        <div className="flex flex-col gap-32">
          ...
          />
          <Contact
            leadingText="Ready to connect your "
            highlightedText="artwork systems?"
