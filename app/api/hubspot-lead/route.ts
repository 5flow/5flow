...
import { createOrUpdateHubSpotWebsiteLead, WebsiteLeadPayload } from '@/lib/hubspot';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await createOrUpdateHubSpotWebsiteLead(data);
